...
%       TITLE PAGE
%----------------------------------------------------------------------------------------
\title[ISDM'25, JISBD, Córdoba]{ISDM'25\\JISBD\\Córdoba\thanks{\url{https://github.com/dsevilla/isdm-jisbd24}}}
...
\pgfdeclareimage[width=\paperwidth]{background}{img/slideMezquita.jpg}
